...
// solutions
	if ($('#hm-solutions-link').is(focusedElement)) {
		//change background color
		$('#hm-solutions').css('background-color','#ccd8e3');
	}else{$('#hm-solutions').css('background-color','');}
...
$("#hm-solutions").click(function() {findchildlink(this);});
